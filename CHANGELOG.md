...
- The shortcuts now spell what they do: ⌃⌥S takes a screenshot, ⌃⌥D draws on
  ...
  keyboard, ⌃⌥O picks a colour and ⌃⌥H opens Hop itself. Every module that
  opens with a key now has one out of the box; eight window zones moved to the
  number row to make room, and every shortcut is still rebindable in settings.
