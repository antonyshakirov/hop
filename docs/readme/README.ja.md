...
[Bahasa Indonesia](README.id.md) · [Deutsch](README.de.md) · [English](../../README.md) · [Español](README.es.md) · [Français](README.fr.md) · [Italiano](README.it.md) · [Nederlands](README.nl.md) · [Polski](README.pl.md) · [Português](README.pt.md) · [Türkçe](README.tr.md) · [Tiếng Việt](README.vi.md) · [Русский](README.ru.md) · [हिन्दी](README.hi.md) · [ไทย](README.th.md) · [한국어](README.ko.md) · [中文](README.zh.md) · **日本語**
...
スイッチ一つで、下のアプリにクリックを返しながら書き込みは画面に残せます。「保存」と「コピー」は画面と描画を一緒に撮ります。画面全体を共有していれば相手にも書き込みが見えます。単一ウインドウの共有は macOS が単独で合成するため、レイヤーは入りません。
...
Bahasa Indonesia, Deutsch, English, Español, Français, Italiano, Nederlands, Polski, Português, Türkçe, Tiếng Việt, Русский, हिन्दी, ไทย, 한국어, 中文, 日本語 – アプリは最初からシステム言語に自動で従います。
...
1.10.0 への更新は権限を一度すべて消し、改めて求める。権限は署名に結び付いており、
Apple が署名したとき Hop の署名は変わった。古い署名に与えた権限は一覧に残ったまま、
もう効かなくなっていた。1.10.0 以降、権限は更新をまたいで残る。
