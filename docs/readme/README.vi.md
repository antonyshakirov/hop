...
Lần khởi chạy đầu tiên: nhấp chuột phải vào `Hop.app` → **Open** → xác nhận
(ứng dụng chưa được notarize). Yêu cầu macOS 14 trở lên.
...
sáng với hiệu ứng hạt phim, phím tắt toàn cục, khởi chạy khi đăng nhập, và
chế độ an toàn giúp khôi phục ứng dụng khỏi vòng lặp crash.
