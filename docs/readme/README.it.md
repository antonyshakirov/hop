...
appunti, convertitore di file, gestore delle finestre, un client torrent
leggero, schermate, disegno sullo schermo, riconoscimento del testo e altro
ancora. Attivi quelli che ti servono e li distribuisci su fino a quattro
...
<img src="https://hop.tools/screens/it/overview.webp" width="360" alt="Pannello di Hop – timer nella barra dei menu con display a matrice di punti, preset e cicli lavoro-pausa">
...
Hop è firmata con un Apple Developer ID e notarizzata da Apple, quindi macOS
la apre come qualsiasi altra app. Il codice sorgente è pubblico e gli
...
<div align="center">
<img src="https://hop.tools/screens/it/timer.webp" width="420" alt="Hop – Timer e cicli">
</div>
...
JSON e Hop ne raccoglie le modifiche mentre è in esecuzione, così un agente – o
uno script, o tu in un editor di testo – può aggiungere un'attività e vederla
comparire. Hop esegue anche
...
<div align="center">
<img src="https://hop.tools/screens/it/tracker.webp" width="420" alt="Hop – Monitoraggio del tempo e attività">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/awake.webp" width="420" alt="Hop – Niente stop">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/system.webp" width="420" alt="Hop – Monitor di sistema">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/clipboard.webp" width="420" alt="Hop – Cronologia degli appunti">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/converter.webp" width="480" alt="Hop – Convertitore di file">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/windows.webp" width="420" alt="Hop – Gestore delle finestre">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/torrents.webp" width="420" alt="Torrent di Hop – client BitTorrent leggero nel pannello della barra dei menu">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/colors.webp" width="420" alt="Hop – Selettore colore">
</div>
...
appunti. Le andate a capo restano, così una tabella o un frammento di codice rimane leggibile. Il
...
<div align="center">
<img src="https://hop.tools/screens/it/recognition.webp" width="480" alt="Hop – Riconoscimento del testo">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/shot.webp" width="480" alt="Hop – Editor di schermate">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/annotate.webp" width="480" alt="Hop – Disegno sullo schermo">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/keyboard.webp" width="480" alt="Hop – Blocco tastiera">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/speed.webp" width="420" alt="Hop – Test di velocità">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/settings.webp" width="480" alt="Hop – Impostazioni">
</div>

### VPN

Tutte le VPN che il tuo Mac conosce, ciascuna col suo interruptore, di qualunque
...
aggiungere né da configurare, e nessun supporto dedicato a un fornitore da
aspettare.

Collega e scollega un tunnel senza aprire niente. Finché un tunnel è su, un puntino
sta nell'angolo dell'icona nella barra dei menu, accanto agli altri indicatori
dell'app, così lo vedi anche a pannello chiuso: verde finché il traffico passa nel
tunnel, arancione quando il tunnel è acceso ma non torna indietro nulla. Una
connessione morta in silenzio smette così di sembrare sana, e il pannello indica la
riga di cui si tratta. Clicca il nome e si apre la finestra di quella VPN per le
volte in cui serve – scegliere un paese o cambiare un'impostazione – e quando la
chiudi Hop chiude di nuovo l'app, così non resta nel Dock e nella barra dei menu per
un interruttore che tocchi due volte a settimana. La connessione resta: il tunnel lo
...
dove sta la macchina, e un paese sbagliato dichiarato con sicurezza è peggio di
nessuno.

Il punto si può spegnere nelle impostazioni: il modulo e i suoi interruttori funzionano lo stesso.

<div align="center">
<img src="https://hop.tools/screens/it/vpn.webp" width="420" alt="Hop – Interruttori VPN">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/apps.webp" width="420" alt="Hop – Griglia di app">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/uninstall.webp" width="480" alt="Hop – Rimuovere un'app con tutto ciò che ha lasciato">
</div>
...
<div align="center">
<img src="https://hop.tools/screens/it/clean.webp" width="480" alt="Hop – Svuotare cache, installer, resti e cestino">
</div>
...
L'aggiornamento a 1.10.0 cancella tutti i permessi una volta e li richiede. Un
permesso appartiene a una firma, e quella di Hop è cambiata quando Apple l'ha
firmata: quelli concessi alla firma precedente restavano in elenco ma non
funzionavano più. Da 1.10.0 sopravvivono a un aggiornamento.
