...
ในครั้งแรกที่เจอ Hop แตก rar ได้แต่ไม่เคยสร้าง เพราะเป็นรูปแบบปิด เปิด «เปิดไฟล์บีบอัดด้วย Hop»
ในการตั้งค่า แล้วดับเบิลคลิกไฟล์บีบอัดจะแตกผ่าน Hop ไม่ว่าโมดูลจะแสดงในแผงหรือไม่
