...
มอนิเตอร์ระบบ ประวัติคลิปบอร์ด ตัวแปลงไฟล์ ตัวจัดการหน้าต่าง
และไคลเอนต์ทอร์เรนต์ตัวเบา คลิกเดียว — ทุกอย่างที่คุณต้องการอยู่ตรงนั้น**
...
Hop อาศัยอยู่บนแถบเมนูของ Mac และเข้ามาแทนที่ยูทิลิตี้เล็ก ๆ นับครึ่งโหล:
ตัวจับเวลาสไตล์ Pomodoro ตัวกันเครื่องหลับแบบ caffeinate มอนิเตอร์ระบบ
ตัวจัดการคลิปบอร์ด ตัวแปลงไฟล์แบบลากมาวาง ตัวจัดหน้าต่าง
และไคลเอนต์ทอร์เรนต์ตัวเบา — แอปเนทีฟเบา ๆ หนึ่งตัวแทนที่เจ็ดตัว
...
กับตอนรับส่งทราฟฟิกทอร์เรนต์เองเท่านั้น อัปเดตและเอนจินทอร์เรนต์
...
Hop ฟรีอย่างสมบูรณ์ ไม่มีช่วงทดลอง ไม่มีเวอร์ชันโปร ไม่มีการซื้อในแอป ไม่มีโฆษณา ไม่มีการเก็บข้อมูล ไม่มีบัญชี จึงไม่มีอะไรให้หารายได้และไม่มีอะไรให้ขาย นี่เป็นโปรเจกต์ส่วนตัว ผมทำ Hop ขึ้นเพื่อใช้เอง ใช้มันทุกวัน และแค่แบ่งปันให้ทุกคน ถ้ามันมีประโยชน์ ก็ช่วยบอกต่อด้วยนะ
