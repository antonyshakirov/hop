...
ในครั้งแรกที่เจอ Hop แตก rar ได้แต่ไม่เคยสร้าง เพราะเป็นรูปแบบปิด «ให้ Hop เป็นค่าเริ่มต้นของไฟล์บีบอัด» ในการตั้งค่าจะรับเฉพาะรูปแบบที่ macOS ไม่มีแอปของตัวเอง โดยเฉพาะ rar และ 7z
และดึงกลับจากแอปภายนอก ส่วน zip และ tar ยังอยู่กับ Archive Utility ใช้ได้แม้ซ่อนโมดูล
และการ์ดแสดงสถานะจริง
