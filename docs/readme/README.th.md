...
แถวของโมดูลจะเปิดหน้าต่างขึ้นมา และการลากมาวางทำในหน้าต่างนั้น วางไฟล์บีบอัดแล้วมันจะแตกอยู่ตรงที่เดิม
วางไฟล์หรือโฟลเดอร์แล้วจะได้ไฟล์บีบอัดหนึ่งไฟล์อยู่ข้าง ๆ zip, tar, tar.gz, tar.bz2, tar.xz และ gz
ใช้ได้ทันที ส่วน rar และ 7z จะดาวน์โหลดตัวช่วยเล็ก ๆ (~6 MB) พร้อมตรวจลายเซ็นในครั้งแรกที่เจอ Hop
แตก rar ได้แต่ไม่เคยสร้าง เพราะเป็นรูปแบบปิด เปิด «เปิดไฟล์บีบอัดด้วย Hop» แล้วดับเบิลคลิกไฟล์บีบอัด
จะแตกผ่าน Hop ไม่ว่าโมดูลจะแสดงในแผงหรือไม่
...
ปุ่มบนแผ่นคลุม ปุ่มในแผงควบคุม การเปิดแผง หรือกด esc ค้างสามวินาที การกดปุ่มเปิดปิดสั้น ๆ ก็ถูกกลืนเช่นกัน
