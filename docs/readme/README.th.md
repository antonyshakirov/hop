...
บนไอคอนมีเครื่องหมายเล็ก ๆ อยู่: เวลาที่กำลังเดิน การกันหลับ การเตือนที่เพิ่งดัง จุดเขียวขณะที่ VPN เปิดอยู่ และลูกศรขณะที่ทอร์เรนต์กำลังวิ่ง — จะเป็นสีหรือขาวดำก็ได้ และปิดได้ทีละอย่าง หน้าต่างของ Hop เองจะโผล่ใน Dock ขณะเปิดอยู่ คลิกเดียวก็เรียกหน้าต่างกลับมาโดยไม่ต้องเปิดแผงก่อน และไอคอนจะหายไปพร้อมหน้าต่างสุดท้าย
