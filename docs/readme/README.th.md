...
ลากไฟล์บีบอัดมาวางบนแผง แล้วมันจะแตกอยู่ตรงที่มันวางอยู่ ลากไฟล์หรือโฟลเดอร์มาวาง
แล้วจะได้ไฟล์บีบอัดหนึ่งไฟล์อยู่ข้าง ๆ รองรับ zip, tar, tar.gz, tar.bz2, tar.xz
และ gz ได้ทันที ส่วน rar และ 7z จะโหลดตัวช่วยเล็ก ๆ (~6 MB) ที่ตรวจลายเซ็นแล้ว
เพียงครั้งเดียว Hop แตกไฟล์ rar ได้แต่ไม่เคยสร้าง เพราะรูปแบบนี้เป็นกรรมสิทธิ์
...
สองโมดูลที่ต้องเปิดเอง สำหรับนักออกแบบและนักพัฒนา หลอดดูดสีจะเก็บสีใดก็ได้บนหน้าจอ
ลงประวัติคลิปบอร์ดเป็น hex, rgb หรือ hsl โดยไม่ต้องขอสิทธิ์บันทึกหน้าจอ ส่วนข้อความ
บนหน้าจอจะครอบพื้นที่แล้วส่งข้อความหรือคิวอาร์โค้ดข้างในไปยังประวัติเดียวกัน
คัดลอกไว้ให้เรียบร้อย

### ล็อกคีย์บอร์ด

กดปุ่มเดียว คีย์บอร์ดทั้งแผงก็หยุดตอบสนอง จะได้เช็ดโดยไม่ต้องปิดเครื่องหรือพับจอ
ออกจากโหมดได้ด้วยเมาส์ หรือตัวจับเวลา 30 วินาที, 1 นาที หรือ 5 นาที
...
- **การช่วยการเข้าถึง** — การวางลงในแอปที่อยู่ข้างล่าง ตัวจัดการหน้าต่าง และการล็อก
  คีย์บอร์ด
- **การบันทึกหน้าจอ** — เฉพาะโมดูลข้อความบนหน้าจอ หลอดดูดสีไม่ต้องใช้
