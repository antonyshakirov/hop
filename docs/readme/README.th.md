...
ตารางของโปรแกรมที่คุณเปิดทั้งวัน อยู่ห
่างแค่คลิกเดียวโดยไม่ต้องเข้าโฟลเดอร์แ
อปกด + แล้วเลือก หรือลากมาจาก Finder แ
ถวหนึ่งวางได้แปดตัว สูงสุดแปดแถว

ลากไอคอนเพื่อย้ายที่ เส้นสีเหลืองจะบอก
ว่ามันจะแทรกอยู่ระหว่างไอคอนคู่ไหน ส่ว
นไอคอนอื่นจะขยับเองเหมือนหน้าจอหลัก ปุ
่มแก้ไขทำให้ไอคอนโยกเบา ๆ แต่ละอันมี ✕
 และตั้งชื่อตารางเองได้ ถ้าคุณจำแอปได้
จากหน้าตาอยู่แล้ว ก็ปิดชื่อใต้ไอคอนได้
ตรงนั้น จะมีกี่ตารางก็ได้ งานไว้พื้นที
่หนึ่ง ที่เหลือไว้อีกพื้นที่ แต่ละอันม
ีแอปของตัวเอง

ตารางเกิดและหายไปในที่เดียวกับที่คุณจั
ดวางโมดูล: ในตั้งค่า หรือในตารางโมดูลเ
อง ซึ่ง ✕ บนป้ายของตารางจะลบมันถาวร ตา
รางใหม่เริ่มต้นว่างเปล่าและบอกไว้แบบนั
้นจนกว่าคุณจะเติมมัน
