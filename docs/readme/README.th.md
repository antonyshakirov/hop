...
ตารางของโปรแกรมที่คุณเปิดทั้งวัน อยู่ห่างแค่คลิกเดียวโดยไม่ต้องเข้าโฟลเดอร์แอป
กด + แล้วเลือก หรือลากมาจาก Finder แถวหนึ่งวางได้แปดตัว สูงสุดแปดแถว

ลากไอคอนเพื่อย้ายที่ เส้นสีเหลืองจะบอกว่ามันจะแทรกอยู่ระหว่างไอคอนคู่ไหน ส่วนไอคอนอื่นจะขยับ
เองเหมือนหน้าจอหลัก ปุ่มแก้ไขทำให้ไอคอนโยกเบา ๆ แต่ละอันมี ✕ และตั้งชื่อตาราง
เองได้ ถ้าคุณจำแอปได้จากหน้าตาอยู่แล้ว ก็ปิดชื่อใต้ไอคอนได้ตรงนั้น จะมีกี่ตาราง
ก็ได้ งานไว้พื้นที่หนึ่ง ที่เหลือไว้อีกพื้นที่ แต่ละอันมีแอปของตัวเอง
