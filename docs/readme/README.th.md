...
ในครั้งแรกที่เจอ Hop แตก rar ได้แต่ไม่เคยสร้าง เพราะเป็นรูปแบบปิด «เปิดไฟล์บีบอัดด้วย Hop» ในการตั้งค่าจะรับเฉพาะรูปแบบที่ macOS ไม่มีแอปของตัวเอง โดยเฉพาะ rar และ 7z
