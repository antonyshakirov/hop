...
Hop ยังรันคำสั่งจากไฟล์และเข้าใจลิงก์ `hop://` ด้วย เอเจนต์เดียวกันนี้ หรือ Shortcut — และผ่านมันคือ Siri
ในภาษาของคุณ — จึงสั่งเริ่มจับเวลา เพิ่มงานพร้อมการเตือน หรืออ่านว่ากำลังทำอะไรอยู่ได้ ดู
